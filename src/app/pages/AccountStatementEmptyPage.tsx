...
export function AccountStatementEmptyPage() {
          ...
          <div className="overflow-x-auto">
            ...
            <div className="block sm:hidden p-3">
              <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-400 text-xs mt-1">Select a date range and submit to view your account statement</p>
              </div>
            </div>
                ...
                <tr>
                  <td colSpan={6} className="px-4 py-16 text-center">
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <p className="text-gray-500 text-sm font-medium">No transactions found</p>
                      <p className="text-gray-400 text-xs">Select a date range and submit to view your account statement</p>
                    </div>
                  </td>
                </tr>
              </tbody>
